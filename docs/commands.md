...
```javascript title="Resources/app.js"
...
```js title="app/lib/purgetss.colors.js (Alloy) or Resources/lib/purgetss.colors.js (Classic)"
module.exports = {
  harlequin: {
    '50': '#ecffe6',
    '100': '#d5fec9',
...
See [The UI Module](purgetss-ui/introduction) for the full API or [Using `purgetss.ui` in Titanium Classic](purgetss-ui/titanium-classic) for native JavaScript examples.
