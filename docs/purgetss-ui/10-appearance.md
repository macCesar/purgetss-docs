...
```json title="Resources/semantic.colors.json"
{
  "surfaceColor": { "light": "#F8FAFC", "dark": "#0F172A" },
  "textColor": { "light": "#0F172A", "dark": "#F8FAFC" },
  "accentColor": { "light": "#2563EB", "dark": "#60A5FA" }
...
See [Using `purgetss.ui` in Titanium Classic](titanium-classic#quick-start) for an animation and Appearance example in the same application.
