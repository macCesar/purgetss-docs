...
:::caution Current cleanup limitation
...
On Android, touch end consolidates `translation`, `rotate`, `scale`, and the equivalent matrix before snap or drop handling. See [Classic drag configuration and lifecycle](titanium-classic#drag-and-drop-objects) for the complete object shape.
