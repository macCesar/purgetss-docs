...
The runtime has no universal 200 ms animation default. The value above is explicit. See the [Classic object reference](titanium-classic#native-animation-objects).
